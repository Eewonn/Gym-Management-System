    ...
    <div class="flex p-8 gap-8 items-stretch h-1/3">
        ...
        <div class="w-1/2 border p-4 bg-[#101010] rounded-md flex flex-col">
            ...
            <form action="" >
                ...
                <div class="mt-4">
                    <button type="submit" name="add_staff_member" class="w-full bg-[#800080] hover:bg-[#690069] cursor-pointer text-white font-semibold py-2 px-6 rounded shadow transition duration-200">
                        Add Staff Member
                    </button>
                </div>
            </form>
        ...
        <div class="w-1/2 border p-4 bg-[#101010] rounded-md flex flex-col">
            ...
            <form action="">
                ...
                <div class="flex gap-4 mt-4 mb-4">
                    ...
                    <div class="flex flex-col w-1/2">
                        <label class="mb-1 text-base font-medium text-gray-200" for="time_in">Time In</label>
                        <input type="time" id="time_in" name="time_in" class="w-full px-2 py-1 rounded bg-black text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-600" required>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <button type="submit" name="mark_attendance" class="w-full bg-[#800080] hover:bg-[#690069] cursor-pointer text-white font-semibold py-2 px-6 rounded shadow transition duration-200">
                        Mark Attendance
                    </button>
                </div>
            </form>
